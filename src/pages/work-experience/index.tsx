    ...
    <div className="work-experience">
      ...
      <Link to="job1">
        <div className="joblist">
          ...
          <div className="joblist__joblist-title">Full-time - Frontend Developer</div>
          ...
          <div className="joblist__joblist-description">
            ...
            develop in the team. My joblist is to develop a MVP for our Saas. The
            platform would be launched in 2020.09 for North American Universities.{" "}
